...
export default function SignInPage() {
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-center bg-zinc-900 text-white">
      <div
      ...
      <div className="relative z-10 w-full max-w-md space-y-8 rounded-lg bg-zinc-900/50 p-10 shadow-2xl backdrop-blur-sm">
